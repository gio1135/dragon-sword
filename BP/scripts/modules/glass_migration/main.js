        ...
        try {
          ...
          if (block) {
            ...
            if (
              ...
              console.warn(
                `[Glass Migration] SUCCESS: Converted ${id} -> ${targetId} at ${blockLoc.x}, ${blockLoc.y}, ${blockLoc.z}`,
              );
            }
          }
        } catch (e) {}
