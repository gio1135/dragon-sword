export function IsBlockAllowedForTool(
  blockIdRaw,
  toolId,
  hasSilkTouch,
  hasFortune,
  ...
  if (type === 'pickaxe') {
    const isOre =
      blockId.includes('_ore') || blockId === 'minecraft:ancient_debris';
  ...
  if (type === 'axe') {
    const isWood =
      ...
      blockId.includes('stem') ||
      blockId.includes('bark');
    const isMiscAxe = [
      'minecraft:melon',
  ...
  if (type === 'shovel') {
    const isGround =
      blockId.includes('sand') ||
      blockId.includes('gravel') ||
      blockId.includes('clay');
    return isGround;
  }
  ...
  if (type === 'hoe') {
    const isHoeBlock =
      ...
      blockId === 'minecraft:nether_wart_block' ||
      blockId === 'minecraft:warped_wart_block' ||
      blockId.includes('sponge') ||
      blockId.includes('hay') ||
      blockId === 'minecraft:shroomlight' ||
      blockId === 'minecraft:target' ||
      blockId === 'minecraft:dried_kelp_block';
    return isHoeBlock;
  }
...
export function getToolCategory(toolId) {
  ...
  if (id.includes('_shovel') || id.includes('shovel') || id.includes('spade'))
    return 'shovel';
